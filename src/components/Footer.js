...
return (
      <div className="w-screen m-auto items-center fixed bottom-0 pb-2 pt-2 bg-white">
        <div className="m-auto items-center justify-center flex flex-row">
          <a className="text-md font-normal text-normal px-6 text-black transition ease-in-out delay-150 duration-150 hover:text-green-300 hover:-translate-y-4" href="mailto:shaun.o.graham@gmail.com">MAIL</a>
